...
export const ImpactCard: React.FC<ImpactCardProps> = ({
    ...
    return (
        ...
        >
            {/* SVG Tech Border - diagonal cuts maiores (20% como TechCard) */}
            ...
            {/* Decorative HUD Elements - apenas no canto superior direito */}
            ...
            {/* Corner Accents - w-8 h-8 como TechCard */}
            ...
            {/* Clipped content - clipPath ajustado para cortes de 20% */}
            <div
            ...
            >
                ...
                {/* Background com gradiente vermelho sutil - SEM backdrop-blur aqui */}
            ...
            {/* Camada de blur separada - backdrop-blur aplicado corretamente */}
            <div
            ...
            <div className={`relative z-20 p-10 h-full flex flex-col justify-between ${highlight ? "min-h-80" : "min-h-70"}`}>
                {/* Ícone com Container de Vidro - posicionado no canto superior direito */}
