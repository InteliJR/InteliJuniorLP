...
import { Award, Cpu, Trophy, ArrowRight, Users, ArrowUpRight } from 'lucide-react';
import { CompaniesCarousel } from '../CompaniesCarousel';

// Dynamic import do ZoomParallax - componente pesado com Framer Motion
const ZoomParallax = dynamic(
    () => import('@/components/ZoomParallax').then(mod => ({ default: mod.ZoomParallax })),
    {
        ssr: true,
        loading: () => (
...
const companies = [
    { name: "BTG Pactual", logo: "https://upload.wikimedia.org/wikipedia/commons/c/c2/Btg-logo-blue.svg", className: "h-14" },
    { name: "Meta", logo: "https://upload.wikimedia.org/wikipedia/commons/7/7b/Meta_Platforms_Inc._logo.svg", className: "h-8" },
    { name: "BCG", logo: "https://upload.wikimedia.org/wikipedia/commons/d/d0/Boston_Consulting_Group_2020_logo.svg", className: "h-10" },
    { name: "Dell", logo: "https://upload.wikimedia.org/wikipedia/commons/a/ae/Dell_logo.svg", className: "h-9" },
    { name: "Banco Pan", logo: "https://upload.wikimedia.org/wikipedia/commons/2/24/Bancopanlogo.png", className: "h-18" },
    { name: "CPTM", logo: "https://upload.wikimedia.org/wikipedia/commons/f/fb/CPTM_%28Logo%29.svg", className: "h-9" },
    { name: "Uber", logo: "https://upload.wikimedia.org/wikipedia/commons/5/58/Uber_logo_2018.svg", className: "h-8" },
    { name: "Ambev", logo: "https://upload.wikimedia.org/wikipedia/commons/5/5b/Ambev_logo.svg", className: "h-10" },
    { name: "Google", logo: "https://upload.wikimedia.org/wikipedia/commons/2/2f/Google_2015_logo.svg", className: "h-10" },
    { name: "Bank of America", logo: "https://upload.wikimedia.org/wikipedia/commons/2/20/Bank_of_America_logo.svg", className: "h-8" },
    { name: "Sírio Libanês", logo: "https://placehold.co/400x200/transparent/ffffff?text=S%C3%ADrio+Liban%C3%AAs", className: "h-26" }
];
            ...
            >
                ...
                <div className="flex gap-18 whitespace-nowrap w-full items-center justify-center px-10">
                    <div className="flex flex-col gap-1 items-start relative">
                        ...
                        >
                            A primeira Empresa,<br />Junior a conquistar
                        </h2>
                        <TextScramble
                            as="span"
                    ...
                    <div className="grid w-full grid-cols-1 md:grid-cols-3 md:grid-rows-[12rem_14rem_12rem] gap-4 px-24">
                        ...
                        >
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-between p-6">
                                {/* Ícone com Container de Vidro */}
                                <div className="w-fit p-3 bg-white/5 border border-white/10 rounded-lg group-hover:border-primary/50 group-hover:bg-primary/10 transition-colors duration-300 backdrop-blur-md">
                                    <Users className="w-6 h-6 text-white group-hover:text-primary transition-colors duration-300" strokeWidth={1.5} />
                                </div>
                                <div className="transform transition-all duration-500 group-hover:translate-x-1">
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative z-10 h-full flex flex-col justify-between p-8">
                                    {/* Ícone com Container de Vidro */}
                                    <div className="w-fit p-3 bg-white/5 border border-white/10 rounded-lg group-hover:border-primary/50 group-hover:bg-primary/10 transition-colors duration-300 backdrop-blur-md">
                                        <Award className="w-6 h-6 text-white group-hover:text-primary transition-colors duration-300" strokeWidth={1.5} />
                                    </div>
                                    <div className="transform transition-all duration-500 group-hover:translate-x-1">
                        ...
                        >
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-between p-6">
                                {/* Ícone com Container de Vidro */}
                                <div className="w-fit p-3 bg-white/5 border border-white/10 rounded-lg group-hover:border-primary/50 group-hover:bg-primary/10 transition-colors duration-300 backdrop-blur-md">
                                    <Cpu className="w-6 h-6 text-white group-hover:text-primary transition-colors duration-300" strokeWidth={1.5} />
                                </div>
                                <div className="transform transition-all duration-500 group-hover:translate-x-1">
